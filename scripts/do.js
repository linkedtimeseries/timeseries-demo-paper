...
';
      ...
      showDocumentDo: function (node) {
        ...
        s += '<li style="height: 0px"><input id="toogle_footnotes" style="width: 40px; position: relative; left: 130px; top: 80px;" type="image" src="media/images/footnote_icon.png" alt="Submit"><p style="position: relative; left: 120px; top: 78px;">Footnotes</p></li>';
        ...
        //------------------------------------------------------
        // Hacky fix to toogle footnotes!!!
        var footnote = document.getElementById('toogle_footnotes');
        footnote.onclick = () => {
          var footnotes = document.getElementsByClassName('note');

          for (let i = 0; i < footnotes.length; i++) {
            if(footnotes[i].style.display == 'none') {
              footnotes[i].style.display = 'block';
            } else {
        ...
        dd.addEventListener('click', function (e) {
          ...
          if (e.target.closest('.resource-print')) {
            //Toogle footnotes on for them to be included in printed version
            var footnotes = document.getElementsByClassName('note');
            for (let i = 0; i < footnotes.length; i++) {
              footnotes[i].style.display = 'block';
            }
